...
covid_simd_hb <-read_csv("raw_data/covid_data/hospital_admissions_hb_simd_20220302.csv")
covid_specialty_hb <- read_csv("raw_data/covid_data/hospital_admissions_hb_specialty_20220302.csv")
hb <- read_csv("raw_data/general/hb14_hb19.csv") %>% janitor::clean_names()
```
...
specialties_raw <- read_csv("raw_data/non_covid/inpatient_and_daycase_by_nhs_board_of_treatment_and_specialty.csv") %>%
 janitor:: clean_names()
